            ...
            <div class="banner_inner d-flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
						<h2>For ile Satranç Tahtasi</h2>
						<div class="page_link">
							<a href="#">Ana Menü</a>
							<a href="#">For ile Satranç Tahtasi</a>
						</div>
					</div>
				</div>
            </div>
        		...
        		<div class="find_inner" >
                    ...
                    <form >
                        ...
                        <div class="form-group">
                            ...
                            <?php
                                echo "<center><table class='satrancTahtasi' border='2'> <tr> <td class='tahtaKose' width='10' > </td>  <td class='tahtaKose' height='10'>A</td>  <td class='tahtaKose' height='10'>B</td> <td class='tahtaKose' height='10'>C</td> <td class='tahtaKose' height='10'>D</td> <td class='tahtaKose' height='10'>E</td> <td class='tahtaKose' height='10'>F</td> <td class='tahtaKose' height='10'>G</td> <td class='tahtaKose' height='10'>H</td></tr>";
                                    for($i=1;$i<=8;$i++)
                                { echo "<tr> 
                                <td class='tahtaKose' width='10' >$i</td>  <td    bgcolor='white' width='60' height='60'> </td>  <td   bgcolor='black' width='60' height='60'> </td> <td   bgcolor='white' width='60' height='60'> </td> <td bgcolor='black' width='60' height='60'> </td> <td   bgcolor='white' width='60' height='60'> </td> <td bgcolor='black' width='60' height='60'> </td> <td  bgcolor='white'  width='60' height='60'> </td> <td bgcolor='black' width='60' height='60'> </td></tr>";
                                            $i++;
                                echo" <tr><td class='tahtaKose'  height='10'>$i</td>  <td   bgcolor='black' width='60' height='60'> </td> <td   bgcolor='white' width='60' height='60'> </td> <td bgcolor='black' width='60' height='60'> </td> <td   bgcolor='white' width='60' height='60'> </td> <td bgcolor='black' width='60' height='60'> </td> <td  bgcolor='white'  width='60' height='60'> </td> <td bgcolor='black' width='60' height='60'> </td> <td bgcolor='white' width='60' height='60'> </td>
