        ...
        <section class="find_view_area p_120"> 
        	<div class="container">
        		<div class="find_inner">
                 ...
                 <form method="POST" action="boy-kilo-endeksi.php">
              ...
              <?php
                  ...
                  if(isset($_POST['b']) && isset($_POST['k'])) {
                    $b=$_POST['b'];
                    $k=$_POST['k'];
                    ...
                    if($v<18.5)
                        printf("vki degeriniz=%.2f zayıf",$v);
                    else if($v<24.9)
                        printf("vki degeriniz=%.2f normal",$v);
                    else if($v<29.9)
                        printf("vki degeriniz=%.2f fazla kilolu",$v);
                    else if($v<34.9)
                        printf("vki degeriniz=%.2f obez",$v);
                    else if($v<39.9)
                        printf("vki degeriniz=%.2f ikinci derece obez",$v);
                        if($v>39.9)
                         printf("vki degeriniz=%.2f morbid obez",$v);     
